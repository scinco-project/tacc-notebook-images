...
#  
#  This should be a superset of the message types sent on any channel other than
#  the shell channel.
...
#  Choices: any of ['shake_256', 'blake2b', 'sha1', 'sha3_384', 'sha256', 'sha3_256', 'sha3_224', 'blake2s', 'sha224', 'sha3_512', 'shake_128', 'ripemd160', 'md5', 'md5-sha1', 'sha512_256', 'sha384', 'sm3', 'sha512', 'sha512_224']
#  Default: 'sha256'
...
## If True, deleting a non-empty directory will always be allowed. WARNING this
#  may result in files being permanently removed; e.g. on Windows, if the data
#  size is too big for the trash/recycle bin the directory will be permanently
#  deleted. If False (default), the non-empty directory will be sent to the trash
#  only if safe. And if ``delete_to_trash`` is True, the directory won't be
#  deleted.
#  Default: False
...
#  Choices: any of ['blake2s', 'sha224', 'sha3_512', 'sha384', 'blake2b', 'sha1', 'sha3_384', 'sha512', 'sha256', 'sha3_256', 'md5', 'sha3_224']
#  Default: 'sha256'
...
## Accept and manage cookies sent by the service side. This is often useful for
#  load balancers to decide which backend node to use.
